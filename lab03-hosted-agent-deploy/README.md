...
`azure.yaml`의 구조를 확인합니다. 현재 Responses container protocol은 `2.0.0`이며,
`1.0.0`은 deprecated되어 두 버전이 호환되지 않습니다. 샘플이 생성한 `2.0.0`을
낮추지 말고 유지합니다
([protocol migration guide](https://learn.microsoft.com/azure/foundry/agents/how-to/migrate-hosted-agent-preview#container-protocol-200)).
최종 형태는 다음과 같습니다.
...
- azure.yaml의 Responses container protocol version은 2.0.0으로 유지
